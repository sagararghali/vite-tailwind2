...
<Navbar title="Comic World"/>
      ...
      <div className= "h-screen bg-[url('war-machine2.jpg')] bg-cover ">
     ...
     <button><FaRegPlayCircle size={70} /></button>
      ...
      <div className='grid mt-[50px]'>
       ...
       <div className=" w-[180px] h-[270px] bg-cover bg-center bg-[url('war-machine1.jpg')]"></div>
      ...
      <div className=' p-2 mt-[40px] ml-10'>
        ...
        <div className='p-5 ml-2 text-3xl font-bold text-white opacity-100 '> War Machine</div>
        ...
        <p className='mt-3 text-white'>War Machine is a 2026 Australian-American science fiction action film directed, co-produced, and co-written by Patrick Hughes.<br/>The film was released theatrically in Australia on February 12, 2026, before releasing on Netflix on March 6.</p>
