...
export default function Godzilla() {
  return (
    ...
    <Navbar title="Comic World"/>
          ...
          <div className= "h-screen bg-[url('/godzilla.jpg')] bg-cover ">
         ...
         <button><FaRegPlayCircle size={70} /></button>
          ...
          <div className='grid mt-[50px]'>
           ...
           <div className=" w-[180px] h-[270px] bg-cover bg-center bg-[url('/thumb-1920-906860.jpeg')]"></div>
          ...
          <div className=' p-2 mt-[40px] ml-10'>
            ...
            <div className='p-5 ml-2 text-3xl font-bold text-white opacity-100 '> Godzilla</div>
